// ESP32-C6 Firmware for Angler Power Monitor
// For ESP32-C6 DevKit and similar boards
// Supports both 2.4 GHz and 5 GHz WiFi
...
// ESP32-C6 DevKit has LED on GPIO 8
#ifndef LED_BUILTIN
...
// ESP32-C6 LED is active LOW on some boards
